...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'youtube', 'twitter', 'facebook', 'twitch', 'profilePictureFile', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'tempProfilePicturePath', 'profilePicturePath', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setTwitch($twitch)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTwitch', array($twitch));

        return parent::setTwitch($twitch);
    }
    ...
    public function getTwitch()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTwitch', array());

        return parent::getTwitch();
    }
