...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'idci_simplemedia.manager' => 'getIdciSimplemedia_ManagerService',
            'idci_simplemedia.twig.simplemedia_extension' => 'getIdciSimplemedia_Twig_SimplemediaExtensionService',
            'idci_simplemedia.type.mediatag' => 'getIdciSimplemedia_Type_MediatagService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Form\ProfileType A UserBundle\Form\ProfileType instance.
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \UserBundle\Form\ProfileType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'lecoindespious_', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Blogger/BlogBundle/Entity'), 2 => ($this->targetDirs[3].'/vendor/idci/simple-media-bundle/IDCI/Bundle/SimpleMediaBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'UserBundle\\Entity');
        $d->addDriver($c, 'Blogger\\BlogBundle\\Entity');
        $d->addDriver($c, 'IDCI\\Bundle\\SimpleMediaBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'BloggerBlogBundle' => 'Blogger\\BlogBundle\\Entity', 'IDCISimpleMediaBundle' => 'IDCI\\Bundle\\SimpleMediaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_139767094f7771c733fb4ee7f0265903f567ff24d8a62833e63f1a3dc2183db5');
    ...
    /**
     * Gets the 'idci_simplemedia.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\SimpleMediaBundle\Service\Manager A IDCI\Bundle\SimpleMediaBundle\Service\Manager instance.
     */
    protected function getIdciSimplemedia_ManagerService()
    {
        return $this->services['idci_simplemedia.manager'] = new \IDCI\Bundle\SimpleMediaBundle\Service\Manager($this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'));
    }

    /**
     * Gets the 'idci_simplemedia.twig.simplemedia_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\SimpleMediaBundle\Twig\SimpleMediaExtension A IDCI\Bundle\SimpleMediaBundle\Twig\SimpleMediaExtension instance.
     */
    protected function getIdciSimplemedia_Twig_SimplemediaExtensionService()
    {
        return $this->services['idci_simplemedia.twig.simplemedia_extension'] = new \IDCI\Bundle\SimpleMediaBundle\Twig\SimpleMediaExtension($this->get('idci_simplemedia.manager'));
    }

    /**
     * Gets the 'idci_simplemedia.type.mediatag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \IDCI\Bundle\SimpleMediaBundle\Form\Type\MediaTagType A IDCI\Bundle\SimpleMediaBundle\Form\Type\MediaTagType instance.
     */
    protected function getIdciSimplemedia_Type_MediatagService()
    {
        return $this->services['idci_simplemedia.type.mediatag'] = new \IDCI\Bundle\SimpleMediaBundle\Form\Type\MediaTagType($this->get('idci_simplemedia.manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'IDCISimpleMediaBundle:Form:fields.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'IDCISimpleMediaBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('idci_simplemedia.twig.simplemedia_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/idci/simple-media-bundle/IDCI/Bundle/SimpleMediaBundle/Resources/views'), 'IDCISimpleMedia');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IDCISimpleMediaBundle' => 'IDCI\\Bundle\\SimpleMediaBundle\\IDCISimpleMediaBundle',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'IDCISimpleMediaBundle:Form:fields.html.twig',
            ),
